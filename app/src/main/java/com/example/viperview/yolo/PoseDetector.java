...
public class PoseDetector {
    ...
    public Bitmap drawSkeleton(Bitmap frame, float[][][] detections, boolean displaySkeletons, boolean displayBBox) {
        ...
        for (float[] det : filtered) {
            ...
            if (displayBBox) {
                paint.setStyle(Paint.Style.FILL);
                paint.setColor(Color.argb(15, 0, 255, 0)); // translucent green fill
                canvas.drawRect(left, top, right, bottom, paint);
                paint.setStyle(Paint.Style.STROKE);
                paint.setColor(Color.rgb(0, 255, 0)); // outline
                canvas.drawRect(left, top, right, bottom, paint);
            }
            ...
            if (displaySkeletons) {
                ...
                // draw keypoints (small white circles)
                ...
                for (int[] pair : skeletonPairs) {
                    ...
                    // region-based color selection
                    if ((i1 == 5 || i1 == 6 || i1 == 7 || i1 == 8 || i1 == 9 || i1 == 10))
                        paint.setColor(Color.CYAN); // arms
                    else if ((i1 == 11 || i1 == 12 || i1 == 13 || i1 == 14 || i1 == 15 || i1 == 16))
                        paint.setColor(Color.MAGENTA); // legs
                    else if ((i1 == 5 || i1 == 6 || i1 == 11 || i1 == 12))
                        paint.setColor(Color.YELLOW); // torso
                    else
                        paint.setColor(Color.RED); // face/head connections
